    ...
    chapters = [
        ...
        Chapter(
            ...
            exercises=[
                ...
                Exercise(
                    name="object_store03",
                    title="Object Pinning & Memory Leaks",
                    path="exercises/03_object_store/object_store03.py",
                    chapter_name="03_object_store",
                    hints=[
                        "Holding ObjectRefs in global scope or long-lived collections pins objects in Plasma.",
                        "Delete or allow ObjectRefs to go out of scope so Plasma can garbage collect them.",
                    ],
                ),
                Exercise(
                    name="object_store04",
                    title="Object Spilling to Disk",
                    path="exercises/03_object_store/object_store04.py",
                    chapter_name="03_object_store",
                    hints=[
                        "When Plasma memory capacity is exceeded, Ray automatically spills cold objects to disk.",
                        "Configure spilling directory via ray.init(_system_config={'object_spilling_config': ...}).",
                    ],
                ),
                Exercise(
                    name="object_store05",
                    title="Serialization Traps & Captured Globals",
                    path="exercises/03_object_store/object_store05.py",
                    chapter_name="03_object_store",
                    hints=[
                        "Avoid capturing large module globals inside remote function definitions.",
                        "Pass large objects explicitly as ObjectRefs via ray.put().",
                    ],
                ),
                Exercise(
                    name="object_store06",
